...
import 'database_cleanup_screen.dart'; // Наш новый экран очистки
...
class DashboardScreen extends StatelessWidget {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            onTap: () => Navigator.pop(context), // Просто закрываем меню
          ),
          ListTile(
          ...
          const Spacer(), // Отталкиваем кнопку очистки в самый низ
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: _buildDrawer(context), // ПОДКЛЮЧИЛИ БОКОВОЕ МЕНЮ
...
// Вспомогательный класс для градиента (чтобы код был чистым)
