...
class PushService {
  static Future<String> sendPushToToken(String token, String title, String body) async {
    try {
      ...
      // 1. Очищаем ключ от любых артефактов и мусора
      ...
      // 2. Идеально нарезаем по 64 символа (стандарт PEM)
      String chunkedPk = '';
      ...
      // ❗ САМОЕ ВАЖНОЕ: Передаем словарь напрямую, чтобы не сломать переносы!
